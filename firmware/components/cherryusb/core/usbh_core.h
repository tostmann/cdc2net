...
struct usbh_hub {
    ...
    uint16_t initial_scan_mask; /* ports already occupied when this hub attached (no C_CONNECTION) */
    uint32_t poll_err_count;    /* status-poll completions that were neither data nor NAK */
};
